...
<head>
    ...
    <title>Product {{$product->name}} uploaded successfully!</title>
</head>
<body>
    <h3>Dear {{ucfirst($product->role)}} {{$product->user_name}},</h3>
    <p>Your product <strong>{{$product->name}}</strong> has been uploaded successfully pending review. Find below your product details:</p>
    ...
    <p>
        We will send you an email once your product is live on our website.
    </p>
    <p>
        Regards,<br>
