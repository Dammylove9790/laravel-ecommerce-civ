...
<head>
  ...
  <title>WEFARM:: Logistics - @yield('title')</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('users.logistics.dashboard')}}" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('users.logistics.dashboard')}}" class="d-block">{{Auth::user()->name}} - {{ucfirst(Auth::user()->role)}}</a>
        </div>
      </div>
