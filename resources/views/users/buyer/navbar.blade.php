...
<head>
  ...
  <title>WEFARM:: Buyer - @yield('title')</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('users.buyer.dashboard')}}" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('users.buyer.dashboard')}}" class="d-block">{{Auth::user()->name}} - {{ucfirst(Auth::user()->role)}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('users.buyer.dashboard')}}" class="nav-link">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('users.buyer.orders')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Orders</p>
                </a>
              </li>
