...
@section('title', 'Farmer Buyer Orders')
...
@section('breadcrumb-link')
    <li class="breadcrumb-item active">Farmer Buyer Orders</li>
@endsection
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-6">
                ...
                <div class="small-box bg-primary">
                    ...
                    <h6>Total Farmer Buyer Orders</h6>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <h6>Delivered Farmer Buyer Orders</h6>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <h6>Shipped Farmer Buyer Orders</h6>
                    </div>
                    <div class="icon">
                    <i class="ion ion-person-add"></i>
                    </div>
            ...
            <div class="col-lg-2 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <h6>Processing Farmer Buyer Orders</h6>
                    </div>
                    <div class="icon">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Processing Farmer Buyer orders <sup><span class="badge bg-warning">{{$processingOrder}}</span></sup></h3>
                                ...
                                @foreach ($buyerOrders as $pBuyerOrder)
                                    @if ($pBuyerOrder['status'] === 'processing')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.admin.orders.farmer_product.show', ['id' => $pBuyerOrder['wefarm_tx_ref'], 'slug' => $pBuyerOrder['slug']])}}">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Shipped Farmer Buyer Orders <sup><span class="badge bg-info">{{$shippedBuyerOrder}}</span></sup></h3>
                                ...
                                @foreach ($buyerOrders as $sBuyerOrder)
                                    @if ($sBuyerOrder['status'] === 'shipped')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.admin.orders.farmer_product.show', ['id' => $sBuyerOrder['wefarm_tx_ref'], 'slug' => $sBuyerOrder['slug']])}}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Delivered Farmer Buyer Order <sup><span class="badge bg-success">{{$deliveredBuyerOrder}}</span></sup></h3>
                                ...
                                @foreach ($buyerOrders as $dBuyerOrder)
                                    @if ($dBuyerOrder['status'] === 'delivered')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.admin.orders.farmer_product.show', ['id' => $dBuyerOrder['wefarm_tx_ref'], 'slug' => $dBuyerOrder['slug']])}}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
