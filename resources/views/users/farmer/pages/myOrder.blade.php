    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">My Processing Orders <sup><span class="badge bg-warning">{{$processingOrder}}</span></sup></h3>
                                ...
                                @foreach ($orders as $pOrder)
                                    @if ($pOrder->order_status === 'processing')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.farmer.orders.self.show', $pOrder->wefarm_tx_ref)}}">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">My Shipped Orders <sup><span class="badge bg-info">{{$shippedOrder}}</span></sup></h3>
                                ...
                                @foreach ($orders as $sOrder)
                                    @if ($sOrder->order_status === 'shipped')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.farmer.orders.self.show', $sOrder->wefarm_tx_ref)}}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">My Delivered Orders <sup><span class="badge bg-success">{{$deliveredOrder}}</span></sup></h3>
                                ...
                                @foreach ($orders as $dOrder)
                                    @if ($dOrder->order_status === 'delivered')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.farmer.orders.self.show', $dOrder->wefarm_tx_ref)}}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
