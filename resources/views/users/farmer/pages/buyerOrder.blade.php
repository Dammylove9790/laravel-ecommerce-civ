...
@section('breadcrumb-link')
    <li class="breadcrumb-item active">Buyer Orders</li>
@endsection
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Processing Buyer Orders <sup><span class="badge bg-warning">{{$processingBuyerOrder}}</span></sup></h3>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Shipped Buyer Orders <sup><span class="badge bg-info">{{$shippedBuyerOrder}}</span></sup></h3>
                                ...
                                @foreach ($buyerOrders as $sBuyerOrder)
                                    @if ($sBuyerOrder['status'] === 'shipped')
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" class="btn btn-primary" href="{{route('users.farmer.orders.buyer.show', ['id' => $sBuyerOrder['wefarm_tx_ref'], 'slug' => $sBuyerOrder['slug']])}}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Delivered Buyer Orders <sup><span class="badge bg-success">{{$deliveredBuyerOrder}}</span></sup></h3>
