...
@section('breadcrumb-link')
    <li class="breadcrumb-item"><a href="{{route('users.farmer.products')}}">Products</a></li>
...
@section('content')
    <div class="container-fluid">
        ...
        <form name="addProductForm" action="{{route('users.farmer.products.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="my-3 col-6 col-sm-4 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        placeholder='' name='productQuantity'>
                        <button class="btn btn-success" type="button">+</button>
                    </div>
                ...
                <div class="my-3 col-12">
                    ...
                    <textarea class="form-control mb-3" name="productDescription" id="productDescription"
                        placeholder="Description of your product" rows="10"></textarea>
                ...
                <div class="my-3 col-12 col-sm-12 col-lg-3">
                    ...
                    <input type='text' class='form-control p-3' id='productAddress'
                        placeholder='' name='productAddress'>
...
@section('js')
    ...
    @include('users.farmer.pages.jsAddProduct')
@endsection
