...
@section('content')
    <div class="container-fluid">
        ...
        <form name="editProductForm" action="{{route('users.farmer.products.update', $product->slug)}}" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="row">
                ...
                <div class="my-3 col-6 col-sm-4 col-lg-3">
                    ...
                    <select name="productCategory" id="productCategory" class="form-control">
                        ...
                        @endforeach
                        <option value="others" @php echo $prodCatSlug === "others" ? "selected" : ""  @endphp>Others</option>
                    </select>
...
@section('js')
    ...
    @include('users.farmer.pages.jsEditProduct')
@endsection
